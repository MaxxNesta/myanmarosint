...
export const REGIONAL_COMMANDS: RegionalCommand[] = [
  ...
  { id:'ygt', abbr:'ရကတ', name:'Yangon Command',              burmese:'ရန်ကုန်တိုင်းစစ်ဌာနချုပ်',          hq:'Mayangone', region:'Yangon Region',                lat:16.86342378492678, lng:96.14844096818418,  insignia:'https://upload.wikimedia.org/wikipedia/commons/3/32/Shoulder_sleeve_insignia_of_Yangon_Region_Command.svg' },
