...
export const BASES: MilitaryBase[] = [
  ...
  { id:95,  regimentMm:'ခလရ (၉၅)',  regimentEn:'LIB 95',  locationMm:'မန္တလေးမြို့',                                                       locationEn:'Mandalay',                           region:'Mandalay Region',           lat:21.97, lng:96.08,          type:'LIB', threat:'MEDIUM', status:'OPERATIONAL' },
