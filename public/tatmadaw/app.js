...
const T = {
  ...
  equipment: [
    ...
    { name:'75/24 Pack Howitzer',        cat:'artillery', type:'75mm Pack Howitzer',          origin:'India',     qty:'', status:'Active', range:'11,100 m (12,043 yd / 6.8 mi)', weight:'880 kg (2,056 lb)',   crew:'', yr:'', price:'', img:'', notes:'ROF: 3 rds/min; Ammo: HE; ၇၅/၂၄ ဟောင်ဝမ်ဇာ (ဝန်တင်) အမြောက်' },
    { name:'76mm Gun M-42',              cat:'artillery', type:'76.2mm Towed Field Gun',       origin:'Yugoslavia', qty:'', status:'Active', range:'13,280 m (14,523 yd / 8.2 mi)', weight:'1,116 kg (2,455 lb)', crew:'', yr:'', price:'', img:'', notes:'ROF: 15–20 rds/min; Ammo: HE M 70, HEAT BK 354; ၇၆ မမ အမြောက် (M-၄၂)' },
    ...
    { name:'105mm Howitzer M-56 A1',     cat:'artillery', type:'105mm Pack Howitzer',          origin:'Yugoslavia', qty:'', status:'Active', range:'15,100 m std / 18,000 m max (16,440 yd / 9.2 mi — 19,685 yd / 11.2 mi)', weight:'2,200 kg (4,840 lb)', crew:'', yr:'', price:'', img:'', notes:'ROF: 6–7 rds/min; Ammo: HE M 51 A5; ၁၀၅ မမ ဟောင်ဝမ်ဇာ (M-56 A1)' },
    { name:'105mm Howitzer M 2 A1',       cat:'artillery', type:'105mm Towed Howitzer',         origin:'USA',        qty:'', status:'Active', range:'11,270 m (12,328 yd / 7 mi)',   weight:'2,264 kg (4,980 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/8/89/M101_howitzer_in_Valpovo%2C_Croatia.jpg', notes:'ROF: 2–5 rds/min; Ammo: HE M 51 A5, HE M 564, SMK WP; ၁၀၅ မမ ဟောင်ဝမ်ဇာ (M 2 A1)' },
    { name:'105mm Howitzer M2A1/M2A2',   cat:'artillery', type:'105mm Towed Howitzer',         origin:'Yugoslavia', qty:'', status:'Active', range:'11,270 m std / 18,084 m max (12,328 yd / 7 mi — 19,777 yd / 11.2 mi)', weight:'2,000 kg (4,400 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/5/5a/M-56-33_105mm_-_Partner_2019_-_1.jpg', notes:'ROF: 6–7 rds/min; Ammo: HE M 51 A5, HE M 564, SMK WP; ၁၀၅ မမဟောင်ဝမ်ဇာ (M2A1/M2A2)' },
    { name:'120mm Mortar (Yugoslav)',     cat:'artillery', type:'120mm Heavy Mortar',           origin:'Yugoslavia', qty:'', status:'Active', range:'4,760 m shallow / 6,064 m steep / 5,450 m charge-3 (5,205–6,630 yd)', weight:'400 kg (882 lb)',   crew:'', yr:'', price:'', img:'', notes:'ROF: 4–10 rds/min; Ammo: HE (M-62/M-49), BA-97; ၁၂၀ မမ စိန်ပြောင်း (ယူဂို)' },
    ...
    { name:'76mm Gun M-48',               cat:'artillery', type:'76.2mm Towed Field Gun',       origin:'Yugoslavia', qty:'', status:'Active', range:'8,600 m (9,405 yd / 5.3 mi)', weight:'705 kg (1,554 lb)', crew:'', yr:'', price:'', img:'', notes:'ROF: 5 rds/min; Ammo: HE M 85/86, HEAT; ၇၆ မမ အမြောက် (M-၄၈)' },
