...
const T = {
  ...
  equipment: [
    ...
    { name:'106mm Recoilless Rifle',       cat:'artillery', type:'106mm Recoilless Rifle',         origin:'Spain',       qty:'', status:'Active', range:'2,015 m direct / 7,680 m indirect', weight:'115 kg (254 lb)', crew:'', yr:'', price:'', img:'', notes:'ROF: 6 rds/min; Ammo: AP, AT, TRAC; ၁၀၆ မမ ကျည်ဆန်မပြန်သေနတ်' },
    ...
    { name:'120mm Mortar Brandt',         cat:'artillery', type:'120mm Heavy Mortar',           origin:'France',     qty:'', status:'Active', range:'4,748 m',                      weight:'83 kg',            crew:'', yr:'', price:'', img:'', notes:'ROF: 4–10 rds/min; Ammo: HE; ၁၂၀မမ စိန်ပြောင်း (ဘရန်နိ)' },
