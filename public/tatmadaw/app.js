...
const T = {
  ...
  equipment: [
    ...
    // ARTILLERY
    { name:'12.7mm AA Machine Gun',       cat:'artillery', type:'12.7mm AA Heavy Machine Gun',    origin:'China',       qty:'', status:'Active', range:'7,000 m (7,654 yd / 4.3 mi) eff: 1,600 m (1.0 mi)', weight:'35.8 kg (79 lb)', crew:'', yr:'', price:'', img:'', notes:'ROF: 80–100 rds/min; Ammo: API, APIT; ၁၂.၇ မမ လေယာဉ်ပစ်စက်သေနတ်' },
    { name:'37mm AA Gun Type-65',         cat:'artillery', type:'37mm Twin-barrel AA Gun',        origin:'China',       qty:'', status:'Active', range:'8,500 m (9,254 yd / 5.3 mi) eff: 3,500 m (2.1 mi)', weight:'2,300 kg (5,070 lb)', crew:'', yr:'', price:'', img:'', notes:'ROF: 120–160 rds/min; Ammo: HE, HE Lt; ၃၇ မမ လေယာဉ်ပစ်အမြောက် (ပုံစံ-၆၅)' },
