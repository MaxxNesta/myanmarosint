...
const T = {
  ...
  army: {
    ...
    artilleryCommands: [
      { num:505, abbr:'မစခ(၅၀၅)', burmese:'အမှတ်(၅၀၅)အမြောက်စခန်းကွပ်ကဲမှုဌာနချုပ်', hq:'Myeik',    hqBurmese:'မြိတ်မြို့',          state:'Tanintharyi Region', stateBurmese:'တနင်္သာရီတိုင်းဒေသကြီး',    desc:'တနင်္သာရီတိုင်းဒေသကြီး၊ မြိတ်မြို့တွင် ဖွင့်လှစ်ထားသည်။',
        battalions:[
          { num:201, loc:'သထုံမြို့နယ်၊ ထောင်းမူကျေးရွာ' },
          { num:301, loc:'မြိတ်မြို့' },
          { num:302, loc:'ထားဝယ်မြို့နယ်၊ ဇဟာကျေးရွာ' },
          { num:303, loc:'ခမောက်ကြီး' },
          { num:304, loc:'ရေဖြူမြို့နယ်' },
          { num:305, loc:'ဟန်ကဒိုင်း' },
          { num:306, loc:'တနင်္သာရီမြို့နယ်' },
          { num:307, loc:'မိချောင်းလှိုင်' },
          { num:308, loc:'ဘုတ်ပြင်းမြို့နယ်' },
          { num:309, loc:'ပြည်ခြား' },
          { num:401, loc:'မြိတ်မြို့နယ်' },
          { num:501, loc:'နန်းတော်ရာ' },
        ]},
      { num:606, abbr:'မစခ(၆၀၆)', burmese:'အမှတ်(၆၀၆)အမြောက်စခန်းကွပ်ကဲမှုဌာနချုပ်', hq:'Thaton',   hqBurmese:'သထုံမြို့နယ်အနီး',   state:'Mon State',          stateBurmese:'မွန်ပြည်နယ်',                desc:'မွန်ပြည်နယ်၊ သထုံမြို့နယ် အနီးတွင်တည်ရှိပြီး ယခင်ကအမှတ်(၄၄)ခြေမြန်တပ်မဌာနချုပ် နေရာဟောင်းဖြစ်သည်။',
        battalions:[
          { num:202, loc:'သထုံမြို့' },
          { num:310, loc:'သိမ်ဇရပ်မြို့' },
          { num:311, loc:'ဘားအံမြို့' },
          { num:312, loc:'ကော့ကရိတ်မြို့' },
          { num:313, loc:'မုဒုံမြို့နယ်၊ ကျောက်တလုံးကျေးရွာ' },
          { num:314, loc:'ဘီးလင်းမြို့နယ်၊ ရွှေရောင်ပြရွာ' },
          { num:315, loc:'သံဖြူဇရပ်မြို့' },
          { num:316, loc:'ရေးမြို့နယ်၊ ကလော့ရွာ' },
          { num:317, loc:'ရေးမြို့နယ်၊ မော့ကနင်ရွာ' },
          { num:318, loc:'မုဒုံမြို့နယ်၊ အဘစ်ရွာ' },
          { num:402, loc:'သထုံမြို့' },
          { num:502, loc:'သထုံမြို့' },
        ]},
      { num:707, abbr:'မစခ(၇၀၇)', burmese:'အမှတ်(၇၀၇)အမြောက်စခန်းကွပ်ကဲမှုဌာနချုပ်', hq:'Meiktila', hqBurmese:'မိတ္ထီလာမြို့',       state:'Mandalay Region',    stateBurmese:'မန္တလေးတိုင်းဒေသကြီး',      desc:'မန္တလေးတိုင်းဒေသကြီး၊ မိတ္ထီလာမြို့တွင် ဖွင့်လှစ်ထားသည်။',
        battalions:[
          { num:209, loc:'မိတ္ထီလာမြို့' },
          { num:319, loc:'မိတ္ထီလာမြို့' },
          { num:320, loc:'မိတ္ထီလာမြို့' },
          { num:321, loc:'မိတ္ထီလာမြို့၊ သပြေဝကျေးရွာ' },
          { num:365, loc:'ကလေးမြို့' },
          { num:368, loc:'ကျောက်ထုမြို့' },
          { num:369, loc:'အရာတော်မြို့' },
          { num:371, loc:'ဂန့်ဂေါမြို့' },
          { num:409, loc:'ပဒါန်းမြို့' },
          { num:508, loc:'မုံရွာမြို့နယ်၊ ကျောက်စစ်ပုံကျေးရွာ' },
        ]},
      { num:808, abbr:'မစခ(၈၀၈)', burmese:'အမှတ်(၈၀၈)အမြောက်စခန်းကွပ်ကဲမှုဌာနချုပ်', hq:'Ottwin',   hqBurmese:'အုတ်တွင်းမြို့',      state:'Bago Region',        stateBurmese:'ပဲခူးတိုင်းဒေသကြီး',         desc:'ပဲခူးတိုင်းဒေသကြီး၊ အုတ်တွင်းမြို့တွင် ဖွင့်လှစ်ထားသည်။',
        battalions:[
          { num:204, loc:'တောင်ငူမြို့' },
          { num:330, loc:'တောင်ငူမြို့' },
          { num:404, loc:'အုတ်တွင်းမြို့' },
          { num:509, loc:'ရွှေတောင်မြို့နယ်' },
          { num:601, loc:'ဥသျှစ်ပင်မြို့' },
        ]},
      { num:901, abbr:'မစခ(၉၀၁)', burmese:'အမှတ်(၉၀၁)အမြောက်စခန်းကွပ်ကဲမှုဌာနချုပ်', hq:'Bawnatgyi',hqBurmese:'ဘောနတ်ကြီးကျေးရွာ',  state:'Bago Region',        stateBurmese:'ပဲခူးတိုင်းဒေသကြီး',         desc:'ပဲခူးတိုင်းဒေသကြီး၊ ဘောနတ်ကြီးကျေးရွာအနီး ရန်ကုန်-မန္တလေး အမြန်လမ်းမကြီး မိုင်တိုင်(၄၁)အနီးတွင်တည်ရှိသည်။ ခေတ္တဌာနချုပ်မှူးသာထားသော အရန်တပ်မဌာနချုပ်တစ်ခုဖြစ်သည်။',
        battalions:[
          { num:204, loc:'တောင်ငူမြို့' },
          { num:205, loc:'ဘောနတ်ကြီးကျေးရွာ' },
          { num:330, loc:'တောင်ငူမြို့' },
          { num:337, loc:'ဗိုလ်ကြီးကျေးရွာ' },
          { num:402, loc:'' },
          { num:405, loc:'ဘောနတ်ကြီးကျေးရွာ' },
          { num:502, loc:'' },
          { num:503, loc:'' },
          { num:504, loc:'ရန်ကုန်တိုင်းဒေသကြီး၊ လေးထောင့်ကန်' },
          { num:602, loc:'' },
        ]},
      { num:902, abbr:'မစခ(၉၀၂)', burmese:'အမှတ်(၉၀၂)အမြောက်စခန်းကွပ်ကဲမှုဌာနချုပ်', hq:'Naungcho', hqBurmese:'နောင်ချိုမြို့',      state:'Shan State',         stateBurmese:'ရှမ်းပြည်နယ်',               desc:'ရှမ်းပြည်နယ်၊ နောင်ချိုမြို့၊ တောင်ခမ်းဒေသတွင် ဖွင့်လှစ်ထားသည်။',
        battalions:[
          { num:206, loc:'နောင်ချိုမြို့နယ်၊ တောင်ခမ်းရွာ' },
          { num:346, loc:'လားရှိုးမြို့' },
          { num:347, loc:'ကွတ်ခိုင်မြို့' },
          { num:348, loc:'ကွမ်းလုံမြို့' },
          { num:350, loc:'မိုင်းရယ်မြို့' },
          { num:351, loc:'တန့်ယန်းမြို့' },
          { num:352, loc:'ကျောက်မဲမြို့' },
          { num:353, loc:'ရပ်စောက်မြို့နယ်၊ အင်တောမြို့နယ်ခွဲ' },
          { num:354, loc:'နောင်ချိုမြို့နယ်၊ တောင်ခမ်းရွာ' },
          { num:406, loc:'နောင်ချိုမြို့နယ်၊ တောင်ခမ်းရွာ' },
          { num:506, loc:'လောက်ကိုင်မြို့နယ်၊ တာရွှေထန်ရွာ' },
          { num:596, loc:'' },
        ]},
      { num:903, abbr:'မစခ(၉၀၃)', burmese:'အမှတ်(၉၀၃)အမြောက်စခန်းကွပ်ကဲမှုဌာနချုပ်', hq:'Aungban',  hqBurmese:'အောင်ပန်းမြို့',      state:'Southern Shan State',stateBurmese:'ရှမ်းပြည်နယ်တောင်ပိုင်း',    desc:'ရှမ်းပြည်နယ်တောင်ပိုင်း၊ အောင်ပန်းမြို့တွင် အခြေစိုက်သည်။',
        battalions:[
          { num:207, loc:'' },
          { num:331, loc:'' },
          { num:349, loc:'ရပ်စောက်မြို့နယ်၊ ကျောက်ဂူကျေးရွာ' },
          { num:355, loc:'' },
          { num:356, loc:'လွိုင်ကော်မြို့' },
          { num:357, loc:'တောင်ကြီးမြို့' },
          { num:360, loc:'ငွေတောင်ရွာ' },
          { num:362, loc:'လွိုင်ကော်မြို့' },
          { num:407, loc:'အောင်ပန်းမြို့' },
          { num:507, loc:'' },
        ]},
      { num:904, abbr:'မစခ(၉၀၄)', burmese:'အမှတ်(၉၀၄)အမြောက်စခန်းကွပ်ကဲမှုဌာနချုပ်', hq:'Mohnyin',  hqBurmese:'မိုးညှင်းမြို့',      state:'Kachin State',       stateBurmese:'ကချင်ပြည်နယ်',               desc:'ကချင်ပြည်နယ်၊ မိုးညှင်းမြို့တွင် အခြေစိုက်ပြီး လက်အောက်ခံ အမြောက်တပ်ရင်း ၁၂ ရင်းရှိသည်။ မြောက်ပိုင်းတိုင်းစစ်ဌာနချုပ်နှင့် အနောက်မြောက်တိုင်းစစ်ဌာနချုပ် နယ်မြေများအတွင်း ဖြန့်ခွဲထားရှိသည်။',
        battalions:[
          { num:208, loc:'' },
          { num:364, loc:'' },
          { num:366, loc:'ဗန်းမော်မြို့' },
          { num:367, loc:'မိုးညှင်းမြို့နယ်' },
          { num:370, loc:'မိုးမောက်မြို့နယ်' },
          { num:372, loc:'မိုးကောင်းမြို့' },
          { num:386, loc:'နမ္မားမြို့' },
          { num:408, loc:'' },
        ]},
      { num:905, abbr:'မစခ(၉၀၅)', burmese:'အမှတ်(၉၀၅)အမြောက်စခန်းကွပ်ကဲမှုဌာနချုပ်', hq:'Padaung',  hqBurmese:'ပဒါန်းမြို့အနီး',    state:'Magway Region',      stateBurmese:'မကွေးတိုင်းဒေသကြီး',         desc:'မကွေးတိုင်းဒေသကြီး၊ မင်းဘူးခရိုင်၊ ပဒါန်းမြို့အနီးတွင်တည်ရှိသည်။',
        battalions:[
          { num:373, loc:'စစ်တွေမြို့' },
          { num:374, loc:'အမ်းမြို့' },
          { num:375, loc:'ငဖဲမြို့နယ်၊ ပဒါန်းမြို့' },
          { num:377, loc:'ကျောက်တော်မြို့နယ်' },
          { num:378, loc:'ဘူးသီးတောင်မြို့နယ်' },
        ]},
      { num:909, abbr:'မစခ(၉၀၉)', burmese:'အမှတ်(၉၀၉)အမြောက်စခန်းကွပ်ကဲမှုဌာနချုပ်', hq:'Kengtung', hqBurmese:'ကျိုင်းတုံမြို့',     state:'Eastern Shan State', stateBurmese:'ရှမ်းပြည်နယ်(အရှေ့ပိုင်း)',  desc:'ရှမ်းပြည်နယ်(အရှေ့ပိုင်း)၊ ကျိုင်းတုံမြို့တွင် ဖွင့်လှစ်ထားသည်။',
        battalions:[
          { num:210, loc:'' }, { num:358, loc:'' }, { num:382, loc:'' }, { num:383, loc:'' },
          { num:384, loc:'' }, { num:385, loc:'' }, { num:386, loc:'' }, { num:387, loc:'' },
          { num:388, loc:'' }, { num:389, loc:'' }, { num:390, loc:'' }, { num:410, loc:'' },
          { num:510, loc:'' }, { num:610, loc:'' },
        ]},
    ],

    armoredCommands: [
      { num:71, abbr:'သစခ(၇၁)', burmese:'အမှတ်(၇၁)သံချပ်ကာစစ်ဆင်ရေးကွပ်ကဲမှုဌာနချုပ်', hq:'Pyawbwe',  hqBurmese:'ပျော်ဘွယ်မြို့',               state:'Mandalay Region', stateBurmese:'မန္တလေးတိုင်းဒေသကြီး',        cmd:'Central Command',         cmdAbbr:'လပခ',
        battalions:[
          { num:6001, name:'တင့်ကားတပ်ရင်း',              abbr:'တကရ', loc:'ပျော်ဘွယ်မြို့' },
          { num:5001, name:'တင့်ကားတပ်ရင်း',              abbr:'တကရ', loc:'မိတ္ထီလာမြို့' },
          { num:5013, name:'တင့်ကားတပ်ရင်း',              abbr:'တကရ', loc:'မကွေးမြို့' },
        ]},
      { num:72, abbr:'သစခ(၇၂)', burmese:'အမှတ်(၇၂)သံချပ်ကာစစ်ဆင်ရေးကွပ်ကဲမှုဌာနချုပ်', hq:'Ohn Taw',  hqBurmese:'စစ်ကိုင်းမြို့နယ်၊ အုန်းတော',  state:'Sagaing Region',  stateBurmese:'စစ်ကိုင်းတိုင်းဒေသကြီး',       cmd:'North-West Command',      cmdAbbr:'နမခ',
        battalions:[
          { num:5004, name:'တင့်ကားတပ်ရင်း',              abbr:'တကရ', loc:'အရာတော်မြို့' },
          { num:6005, name:'တင့်ကားတပ်ရင်း',              abbr:'တကရ', loc:'အုန်းတောရွာ' },
          { num:6006, name:'တင့်ကားတပ်ရင်း',              abbr:'တကရ', loc:'ကန့်ဘလူမြို့' },
          { num:7004, name:'သံချပ်ကာတိုက်ခိုက်ရေးတပ်ရင်း', abbr:'သတရ', loc:'မြစ်ကြီးနားမြို့' },
          { num:7005, name:'သံချပ်ကာတိုက်ခိုက်ရေးတပ်ရင်း', abbr:'သတရ', loc:'မိုးညှင်းမြို့' },
          { num:7006, name:'သံချပ်ကာတိုက်ခိုက်ရေးတပ်ရင်း', abbr:'သတရ', loc:'ဗန်းမော်မြို့' },
          { num:5014, name:'တင့်ကားတပ်ရင်း',              abbr:'တကရ', loc:'ဗန်းမော်မြို့' },
        ]},
      { num:73, abbr:'သစခ(၇၃)', burmese:'အမှတ်(၇၃)သံချပ်ကာစစ်ဆင်ရေးကွပ်ကဲမှုဌာနချုပ်', hq:'Nam San',  hqBurmese:'နမ့်စန်မြို့',                 state:'Shan State',      stateBurmese:'ရှမ်းပြည်နယ်',                  cmd:'Eastern Central Command', cmdAbbr:'ရလခ',
        battalions:[
          { num:7014, name:'သံချပ်ကာတပ်ရင်း',             abbr:'သကရ', loc:'သီပေါမြို့' },
          { num:7001, name:'သံချပ်ကာတပ်ရင်း',             abbr:'သကရ', loc:'ကျိုင်းတုံမြို့' },
          { num:7002, name:'သံချပ်ကာတပ်ရင်း',             abbr:'သကရ', loc:'မိုင်းဖြတ်မြို့' },
          { num:7003, name:'သံချပ်ကာတပ်ရင်း',             abbr:'သကရ', loc:'မိုင်းဆတ်မြို့' },
          { num:5003, name:'တင့်ကားတပ်ရင်း',              abbr:'တကရ', loc:'နမ့်စန်မြို့' },
          { num:6003, name:'တင့်ကားတပ်ရင်း',              abbr:'တကရ', loc:'မိုင်းတုံမြို့' },
          { num:5002, name:'တင့်ကားတပ်ရင်း',              abbr:'တကရ', loc:'မိုင်းမောမြို့' },
          { num:6007, name:'တင့်ကားတပ်ရင်း',              abbr:'တကရ', loc:'လားရှိုးမြို့' },
        ]},
      { num:74, abbr:'သစခ(၇၄)', burmese:'အမှတ်(၇၄)သံချပ်ကာစစ်ဆင်ရေးကွပ်ကဲမှုဌာနချုပ်', hq:'Hlegu',    hqBurmese:'လှည်းကူးမြို့နယ်၊ အင်းတိုင်ရွာ', state:'Yangon Region',  stateBurmese:'ရန်ကုန်တိုင်းဒေသကြီး',          cmd:'Yangon Command',          cmdAbbr:'ရကတ',
        battalions:[
          { num:5010, name:'တင့်ကားတပ်ရင်း',              abbr:'တကရ', loc:'ကိုးလုံးကွင်းကျေးရွာ မှော်ဘီမြို့နယ်' },
          { num:7010, name:'သံချပ်ကာတိုက်ခိုက်ရေးတပ်ရင်း', abbr:'သတရ', loc:'အင်းတိုင်ကျေးရွာ လှည်းကူးမြို့နယ်' },
          { num:7007, name:'သံချပ်ကာတိုက်ခိုက်ရေးတပ်ရင်း', abbr:'သတရ', loc:'အင်းတိုင်ကျေးရွာ လှည်းကူးမြို့နယ်' },
        ]},
      { num:75, abbr:'သစခ(၇၅)', burmese:'အမှတ်(၇၅)သံချပ်ကာစစ်ဆင်ရေးကွပ်ကဲမှုဌာနချုပ်', hq:'Thagara',  hqBurmese:'ရေတာရှည်မြို့နယ်၊ သာဂရမြို့', state:'Bago Region',     stateBurmese:'ပဲခူးတိုင်းဒေသကြီး',             cmd:'Southern Command',        cmdAbbr:'တပခ',
        battalions:[
          { num:7012, name:'သံချပ်ကာတိုက်ခိုက်ရေးတပ်ရင်း', abbr:'သတရ', loc:'တီတွတ်မြို့' },
          { num:7013, name:'သံချပ်ကာတိုက်ခိုက်ရေးတပ်ရင်း', abbr:'သတရ', loc:'တောင်ငူမြို့နယ်' },
          { num:7011, name:'သံချပ်ကာတိုက်ခိုက်ရေးတပ်ရင်း', abbr:'သတရ', loc:'မုဒုံမြို့' },
        ]},
    ],
  },
  ...
  equipment: [
    // ARMOR
    { name:'T-72 Ural (variants)',    cat:'armor',     type:'Main Battle Tank',          origin:'Russia/Ukraine', qty:'~50',  status:'Active',  gun:'125mm 2A46M smoothbore', speed:'60 km/h', weight:'41.5t', crew:3,   yr:'2000s',      price:'~$2.5M/unit', img:['https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhvywh5_pXy9-PV0S8NIGM8CnquUfCClV2WB7AbGedXVN9uOvRhvO84vwMDhW8IBAK3yeUFpbx76128r2-FVd3RuzzxoMHHf0eplWPPAG0DALmQhbP-p6mOw_Xut1uuGNt5KmNel_WicUGM/s1600/T-72_Tanks_Myanmar_army.JPG','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEheE9KL5XVsk233A9oXU3-1yb7n_mQJpZn-Gt15JmWLn-NlczH54un-4y_R0W9jMW6XaONvBENmtB6QNXOim-56CP-8BhTahWsj2EpYMSrwp5SKrhbjBBdLa_MqbSBfQE-McZo18h6823X-/s1600/mmmilitary+T-72S+MBT+%25284%2529a.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEilQDpGKJaJEHjBygkvcLt6zbywXPkXLAHiHoiQS4p43Ph9rDfunnPaAtzvac4MOghXYyCqOnjTseSVoj9wVDM5MXgUWCVLETXKFwvXzNKMubo4nyrLZvPXFrUly1JLhNhxFUg2E1SzzWmA/s1600/mmmilitary+T-72S+MBT+%25281%2529a.jpg'], notes:'Primary heavy tank; T-72M1/T-72S variants operated by Myanmar Army' },
    { name:'Type 59 (WZ-120)',        cat:'armor',     type:'Main Battle Tank',          origin:'China',          qty:'250+', status:'Active',  gun:'100mm Type 59 rifled',   speed:'50 km/h', weight:'36t',   crew:4,   yr:'1970–1990s', price:'~$1.5M/unit', img:['https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjLGX0Muq799H5jSROpmoIIMibqDURrblJkx3sHIgEJ_wOXPcXMK7YY8kk8DOqaNqIkJAA6y51LR17deDQ4AvHKVeEi_-lR-SOMtqOGmUXqstNKuG5TZrRqMXK9InOxmoQYUvxfmG-5QII/s1600/6.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhCEXxbpmnju3r09UFZA84oZl2rXMJUvcPFGT4dNS-y3Vt12Ed_RS-1iHlusx-3ZYvhuWjj8_4iEr5Ts8lH5nbSuolp0SgHcJLPTCEmostsHu939R4CjjHdzqUllwYMvH6kvdspfQKJkXo/s1600/mmmilitary+72nd+MAF+parade+%252812%2529.jpg'], notes:'Bulk of tank force; aging fleet' },
    { name:'Type 69-IIG',             cat:'armor',     type:'Main Battle Tank',          origin:'China',          qty:'130+', status:'Active',  gun:'100mm smoothbore',       speed:'50 km/h', weight:'36.7t', crew:4,   yr:'1990s',      price:'~$1.8M/unit', img:['https://www.armyrecognition.com/images/stories/analysis_focus/analysis/Myanmar_Army_is_largest_user_of_Chinese_armament_in_Southeast_Asia1.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEinkyWmUdfiMzQdN3p5x_mHn5_pgfhze79badY29IFF09oTKT386ufx7lqgf9OUYbDTIueGnrbshok1xWvY0q7Hg7d8QlD2VsGsg5kyaJHHIT9EfoSx6MYSVToymjHjwH4r2k0DEUF5ykw/s1600/type69.jpg'], notes:'Improved Type 59 derivative' },
    { name:'MBT-2000 / Type 90-II (Improved)', cat:'armor', type:'Main Battle Tank', origin:'China/Pakistan', qty:'~10', status:'Active', gun:'125mm smoothbore autoload (APFSDS, HE, HEF, ATGM-capable)', speed:'65 km/h', weight:'46t', crew:3, yr:'2010s', price:'~$4M/unit', img:['https://southeastasiaglobe.com/wp-content/uploads/2017/03/tank.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi56qAUkoONxrwpMpDRRJOV07O_Eo7NZmmoUoMmE8nQGznk9rLoVFgvFcziuwgdtCkK4ku73CL7uXotuDhlrHWmjfdEYFEAyyV4ocHDEQl49WgF5lsSVT6fPWd4Poe01Sopa1T4-DHS9mRo/s1600/MBT-2000+Myanmar-8.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgQ6f6N_RDlcRPKMzYA0m58pT7bkcKrTmQvGzqW8ydrkGDM7Abi1X3JaP-u_Q5pbCJuDQblV3e-DOE6cE8mcJm3RezkBsfkVoehTQs8ox2qLN2IE3OCP9pl8jQMdX791P-1Zi1e421h2xc_/s1600/MBT+2000+tanks+of+Myanmar+Army.JPG'], notes:'Improved variant; arrow-shaped add-on armour modules on turret frontal arc; roof-mounted 14.5mm QJG02-type AA MG; slightly shorter hull (engine latitudinal). Main gun: 125mm auto-loaded smoothbore, 39 rounds, APFSDS/HE/HEF + 9M119 Refleks ATGM-capable. FCS: computerised, stabilised commander & gunner sights (day/TI), laser rangefinder, auto-tracker. Secondary: 7.62mm coaxial MG + 12.7mm cupola AA MG. Protection: composite armour (exchangeable frontal arc), 2×6 smoke/HE grenade launchers. Engine: 1,200 hp diesel (CV-12 Condor or 6TD-2); L 9,865mm × W 3,500mm × H 2,370mm; Trench 2,700mm; Gradient 60%; Most capable MBT in Myanmar inventory.' },

    { name:'Comet A34',               cat:'armor',     type:'Medium Tank',               origin:'UK',             qty:'~10',  status:'Limited', gun:'77mm HV QF',             speed:'51 km/h', weight:'35.7t', crew:5,   yr:'1950s',      price:'Heritage',    img:['https://topwar.ru/uploads/posts/2021-03/thumbs/1617156397_ja2.jpg','https://topwar.ru/uploads/posts/2021-03/thumbs/1617156382_ja.jpg'], notes:'WWII-era; ceremonial/reserve' },
    { name:'BTR-3U Guardian',         cat:'armor',     type:'Armored Personnel Carrier', origin:'Ukraine/Myanmar', qty:'800+', status:'Active',  gun:'30mm KBA cannon + PKT',  speed:'80 km/h', weight:'16.4t', crew:'3+8', yr:'2013–2022', price:'~$0.8M/unit', img:['https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi6MnxJvDzXh_nUAPOORwyN3kD54jgIOhbg0bE-Z0mK07YuOlju_C5Z5pBsku5R7aEMhFuMa5LcONaS5dXacGHIv9AkYbFTkmwQdXoUTkof-sMy9BWBf2b_KnaSe3zS3Au7_8g8b0GG44fz/s1600/myanmar_bangladesh_war.JPG','https://d2c13moo8u717n.cloudfront.net/wp-content/uploads/sites/11/2021/02/15100818/2021-02-15T010341Z_1_LYNXMPEH1E01A_RTROPTP_4_MYANMAR-POLITICS-2048x1366.jpg','https://www.geopoliticalmonitor.com/wp-content/uploads/2024/06/Burma_Army_BTR-3u.png'], notes:'Primary APC; fully amphibious' },
    { name:'Type 85 APC',             cat:'armor',     type:'Armored Personnel Carrier', origin:'China',          qty:'250',  status:'Active',  gun:'12.7mm HMG',             speed:'65 km/h', weight:'15t',   crew:'2+10', yr:'1990s',   price:'~$0.5M/unit', img:'https://www.armyrecognition.com/images/stories/analysis_focus/analysis/Myanmar_Army_is_largest_user_of_Chinese_armament_in_Southeast_Asia_2.jpg', notes:'Standard infantry APC' },

    { name:'ZSL-92 APC',             cat:'armor',     type:'Armored Personnel Carrier / IFV', origin:'China',       qty:'450+', status:'Active',  gun:'ZPT-90 25mm (ZSL-92) / QJC-88 12.7mm (ZSL-92A) / ZPT-99 30mm (ZSL-92B)', speed:'85 km/h', weight:'12.5–15.8t', crew:'3+9', yr:'', price:'', img:'https://tse1.mm.bing.net/th/id/OIP.Nef714F1FVkCP-r35pLYMgHaFQ?cb=thfvnextfalcon&rs=1&pid=ImgDetMain&o=7&rm=3', notes:'Engine: BF8L413F 8-cyl turbo diesel 320 hp; Trans: ZF 5S-lllGPA; Suspension: independent wheel; Armor: welded steel; L 6.63m × W 2.80m × H 2.80m; Secondary: Type 86 7.62mm coaxial MG; Op. range: 800 km; Variants: ZSL-92A (12.7mm), ZSL-92B (30mm), PTL-02 (100mm)' },
    { name:'WMA301 (PTL-02)',         cat:'armor',     type:'Tank Destroyer / Assault Gun', origin:'China',         qty:'150+', status:'Active',  gun:'105mm NATO-compatible rifled gun', speed:'85 km/h', weight:'~16t', crew:4, yr:'', price:'', img:'https://i1.kknews.cc/43YMB9imda1F1rexsJdMpsGtf7T4TDmKKZMkxqhuxBs/0.jpg', notes:'Also known as PTL-02; derivative of ZSL-92 with redesigned turret and 105mm NATO gun; fire support vehicle; WMA301 တိုက်ကားဖျက်ကွင်း' },
    { name:'MMT-40',                   cat:'armor',     type:'Light Tank',                origin:'Ukraine/Myanmar', qty:'80+',  status:'Active',  gun:'105mm WMA301-type', speed:'62 km/h', weight:'', crew:3, yr:'', price:'', img:['https://p1-tt-ipv6.byteimg.com/origin/pgc-image/8a8638f481144c0c9f080b2e6a103f26.jpg','https://vpk.name/file/img/legkie-tanki-mmt-40-ukrainskoi-razrabotki-vpervye-predstavleny-na-voennom-parade--fxbkhal4-1673452081.t.jpg'], notes:'Ukrainian-developed light tank produced/operated by Myanmar. Main armament: 105mm WMA301-type gun. Secondary: 12.7mm QJC-88A HMG (roof) + 7.62mm Type 86 LMG (coaxial). Armour: 30mm turret front, 20mm turret sides/hull front/LFP, 15mm turret rear, 10mm turret roof, 7mm hull sides/roof/UFP. Approx. ammo: 30× 105mm, 600× 12.7mm, 1,000× 7.62mm. Engine: YaMZ-238N V8 diesel 300 hp; manual 5F/1R transmission; amphibious at 6 km/h.' },
    { name:'MT-LBMSh',                cat:'armor',     type:'Armored Personnel Carrier / IFV', origin:'Ukraine',        qty:'',     status:'Active',  gun:'30mm KBA-105 "Shkval" autocannon + KT-7.62mm MG + KBA-117 30mm grenade launcher + Barrier ATGM', speed:'', weight:'', crew:'', yr:'2017+', price:'', img:['https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhxh37jXFwXYC_Xk2MGUILBGUGZY5-juDiKspcSK1M67cYNus2RkcD64acDAF4FK-JO4oJihc_6jr2EBXJwhm69zkM5tRngA4-Aqq5SRnOQTnKwe76i950TCMmjyG1JYJ8Bu9t8_HeF1R8q/s1600/mmmilitary.jpg','https://forum-en-cdn.warthunder.com/original/3X/f/4/f47545d2ec09372f43b356ed826c68ead493aa4a.jpeg'], notes:'Announced 2017; built by Kharkiv Tractor Plant (KhTZ), Ukraine. Combat module: KBA-105 "Shkval" with 30mm autocannon, KT-7.62mm coaxial MG, KBA-117 30mm grenade launcher, 6× 902B Tucha smoke grenade launchers, and Barrier ATGM system. Reinforced armour package; new YaMZ-238B engine 330 hp.' },
    { name:'Panhard AML-90',          cat:'armor',     type:'Armored Car / Light Recon',  origin:'France',         qty:'~50',  status:'Limited', gun:'90mm DEFA D921 low-pressure rifled gun', speed:'90 km/h', weight:'5.5t', crew:3, yr:'1960s–1980s', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Panhard_AML-90_img_2308.jpg/960px-Panhard_AML-90_img_2308.jpg', notes:'AML H-90 / AML-245C. DEFA D921 90mm low-pressure rifled gun — first 90mm LP gun mass-produced in France; fin-stabilised ammunition. Designed for rearguard and anti-tank reconnaissance duties. At 5.5t, among the lightest vehicles ever to mount a 90mm weapon. Secondary: 7.62mm coaxial MG. Amphibious with preparation.' },
    { name:'MAV-1 / MAV-2 / MAV-3 / MAV-4', cat:'armor', type:'Armored Personnel Carrier (Domestic)', origin:'Myanmar', qty:'250+', status:'Active', gun:'12.7mm HMG (variant-dependent)', speed:'', weight:'', crew:'', yr:'', price:'', img:['https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiYmfYHntxYyh2ftj-cITcdLhOvOPB9w_xAnECAePThDSwPimRN13uQxumoTVhXtZbQyrKUx9qkjlzIrbHo4wIcF6NKahdiA5gXFaJYjYYvlWzar10gdmVR6382lMFMI23JiICFlfSRtfA/s1600/1601250_575653609181301_1532733756_n.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhpZ_S49Pai_bpfYEkYuEZ-0DdXBz6xF9yG5t86JtF_BEf36L51tiZJoivpD2fG1twfRTm12Vc3LlcMzzXFyD6_vElm631Z2G5rSd_jb8zL8i6g16yQwFifVeycx6Nt4Jt8dZ8RodZboiTq/s1600/mmmilitary+MAVs+%25282%2529.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj5Hh4X9mmrdqaabifJHWPuVbBVP64Hz6UwcDOMQrc6zqXjxkZ_8uCETMetswYb3dqb5DftwgeqQlTOtPebo2hstSMMVTvNP7jh3nzxfvfMTh_yYFgmzUN1W8KkyElLk5k8d08Hir4yUoE/s1600/1526371_620164964698195_567506686_n.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi3SOf0vZ1j9WMUhGfNd40e0UlMIRzt8b6bdLXTRn6IYtJfrDjX9FufKdnypdqlrvlIPc8cCC9vMgPbwwiOIojj7LueCW4FhDmZXxHS-HuPozvnhQPJcvi6mAccuIrnzlM1Zl0tRInymHcy/s1600/mmmilitary+MAVs+%284%29.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEggfFr3f6iKGHxcrq6eqVE9WHWyawwU_Cttz6mDw-Q4L5GaChRZdf-y_7KE82KHxFbqHbcJyBmD3fCjLfFHG7E_yrSH7f6an0eE2GSVp5bbKb85FBQc3HBv8pJJOEG7s5vAhpA88hFeiS4/s1600/1535642_620165754698116_1541858921_n.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhcRW4Y74mfs73NiNZLrce7BQ3NaQbP2h1z3WRPIDN09Pm46zXDlyY5jwYi3m4HzuGh6SjhrR6QGqXu-jrGKIQPUWDXJp1mNOUZDLCyyCd2yFRCyGvDRi-d18RyCYsykmd8bHJN_jtsPYpR/s1600/mmmilitary+MAVs+%281%29.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh5p2a1VcWjddJ-iU-peXkAjuDCpRLHxu-V4p1uMMBWm-idwahFskGtopYbegAaLGQcdENBhRbId8whyphenhyphenU0SF_0GBbIpldngW6ur4ki_p_5sPkk2pMGesWHJDglbeoGfJ4OaoySgeqPc3iI/s1600/1545630_620166011364757_765237336_n.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiz8U96AD50Re8LfXNe1Am6UzIU1lFdAeT5LtLMrqdngyle-iBVSLgi_v-ccCtuK-rSQwLFnRJlgy-Ia3_YgGggZEAknrbAm-wlMs5uEo46oIanLGCTa69jjjFclXbzMtklMD6DTPbQ8ghB/s1600/mmmilitary+MAVs+%283%29.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhBqoJ_sM5uY7lUYL3Iz9sUzOfelp4XJNTCFcuky8rgyBXQRznRxrQrtHtHY91bxNhL23XJRpOP_oaih0XCKEbqdIZ_38cUIrc3StleBWQCgcsdP2T-YmMeDby9TIJs9Vjfao1Bug-Sx5w/s1600/1555518_620166318031393_1017783316_n.jpg'], notes:'Domestically produced APC family in 4 variants. MAV-1: baseline wheeled APC. MAV-2: modified hull/armament. MAV-3: further development with revised superstructure. MAV-4: latest variant. All produced at Myanmar\'s Defense Industries facilities. Part of the Army\'s modernisation and indigenisation programme.' },
    { name:'EE-9 Cascavel',              cat:'armor',     type:'Wheeled Armored Car',        origin:'Brazil',         qty:'150+', status:'Active',  gun:'90mm Engesa EC-90 (44 rounds)', speed:'100 km/h', weight:'12t', crew:3, yr:'', price:'', img:['https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiac1fJY5dmS62TuYC3wytRayGHf7OwYYmQAuGMd2gO4iIPA22gEPoMDblFUsDL_T26f6Ld8epKRSH6SAXVmszYwBkuvkrG-J6ff6vbmvJMzY6Bl5vOJubzGq2dMaOxYTYwKYF26dyzSvY/s1600/EE-9+(1).jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjrtEq_MzAbkx1YVTr9R2ezemCMl465uI5K-MGMR1OKJA6oANCOEBPoNt0rvevCa_c3vqs1x9Bz4KCoXPAJ2-KRL-bEdMcCkebQ0RsB4ThuWPFuQVmgdRzy0mihgY5-Qn_qs8SI2_WptCE/s1600/EE-9+(2).jpg'], notes:'6×6 wheeled armored car. Main armament: 90mm Engesa EC-90 low-pressure gun, 44 rounds. Secondary: 2× FN MAG 7.62mm MG (2,200–2,400 rounds). Engine: Detroit Diesel 6V-53N 5.2L 6-cyl water-cooled diesel, 212 hp at 2,800 rpm. Suspension: 6×6 double axle boomerang drive. Ground clearance: 375mm. Fuel: 360L. Dimensions: L 6.29m × W 2.59m × H 2.60m. Range: 750 km; Max speed: 100 km/h.' },
    { name:'BRDM-2MS',                   cat:'armor',     type:'Armored Reconnaissance Vehicle', origin:'Soviet Union / Russia', qty:'100+', status:'Active', gun:'14.5mm KPVT HMG + 7.62mm PKT coaxial MG', speed:'100 km/h', weight:'7.7t', crew:4, yr:'2021+', price:'', img:['https://www.armyrecognition.com/images/stories/news/2021/april/Russian_BRDM-2MS_4x4_modernized_armored_vehicles_in_service_with_Myanmar_army_925_001.jpg','https://p1-tt-ipv6.byteimg.com/origin/pgc-image/7b64fed0c4e348d9aefa1ed4998521e0.jpg','https://p1-tt-ipv6.byteimg.com/origin/pgc-image/ca6612d421c84373a557cc8bb2d41d1b.jpg','https://p1-tt-ipv6.byteimg.com/origin/pgc-image/901fb8365a7e416e868f02a723145a7d.jpg'], notes:'Modernised BRDM-2MS variant; manufactured at Gorky Automobile Factory (GAZ), Soviet Union. In service since 1962; BRDM-2MS is an upgraded export version. Armament: 14.5mm KPVT heavy machine gun + 7.62mm PKT coaxial MG in a conical turret. Drive: 4×4 with additional belly wheels for obstacle crossing. Fully amphibious — water-jet propulsion. Max road speed: 100 km/h. Ideal for reconnaissance and patrol.' },
    // ARTILLERY
    { name:'12.7mm AA Machine Gun',       cat:'artillery', type:'12.7mm AA Heavy Machine Gun',    origin:'China',       qty:'', status:'Active', range:'7,000 m (7,654 yd / 4.3 mi) eff: 1,600 m (1.0 mi)', weight:'35.8 kg (79 lb)', crew:'', yr:'', price:'', img:'https://tse4.mm.bing.net/th/id/OIP.C8aobp9gn29eWtul83yaQgHaG3?cb=thfvnextfalcon&w=650&h=603&rs=1&pid=ImgDetMain&o=7&rm=3', notes:'ROF: 80–100 rds/min; Ammo: API, APIT; ၁၂.၇ မမ လေယာဉ်ပစ်စက်သေနတ်' },
    { name:'14.5mm QJG-02G AA Gun',       cat:'artillery', type:'14.5mm AA Machine Gun (Licensed)', origin:'China',      qty:'50/yr licensed', status:'Active', range:'', weight:'', crew:'', yr:'', price:'', img:'https://pic.baike.soso.com/ugc/baikepic2/10143/20160726153922-1475104746.jpg/300', notes:'Licensed production; 50 units/year; ၁၄.၅ မမ QJG-02G AA ပစ်စက်' },
    { name:'MR-4 (ZPU-4)',                cat:'artillery', type:'14.5mm Quad-barrel AA Gun',       origin:'Romania',     qty:200, status:'Active', range:'1,400 m eff / 4,000 m max', weight:'', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/0/02/MY-ZPU4-1.jpg', notes:'Romanian variant of ZPU-4; 4 barrels; Feed: 150-round belt each; Ammo: 14.5×114mm; Short recoil action; MR-4 (ZPU-4) ၁၄.၅ မမ AA အမြောက်' },
    { name:'ZU-23-2 Type 87',             cat:'artillery', type:'23mm Twin Autocannon AA Gun',     origin:'Russia/China', qty:380, status:'Active', range:'2,000–2,500 m eff / 1,500–2,000 m altitude', weight:'950 kg (2,094 lb)', crew:'6', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/e/e8/Zu-23_30_M1-3_-_InnovationDay2013part1-40.jpg', notes:'ROF: 2,000 cyclic / 400 practical rpm; MV: 970 m/s; Barrel: 2m L/87.3; Ammo: 23×152mm; L 4.57m × W 2.88m × H 1.22m; ၂၃ မမ ZU-23-2 Type 87 AA အမြောက်' },
    { name:'37mm AA Gun Type-74',         cat:'artillery', type:'37mm Twin-barrel AA Gun',        origin:'China',       qty:24, status:'Active', range:'5,000 m max / 4,000 m eff ceiling', weight:'2,100 kg (4,600 lb)', crew:'8', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/f/f3/Bangladesh_Army_Air_Defence_Artillery_37mm_T-74_%2823848577803%29.jpg', notes:'ROF: 160–170 rpm; MV: 880 m/s; Shell: 37×252mm SR; Elevation: −5° to 85°; Traverse: 360°; Upgraded from Type 65; ၃၇ မမ လေယာဉ်ပစ်အမြောက် (ပုံစံ-၇၄)' },
    { name:'40mm AA Gun',                 cat:'artillery', type:'40mm Towed AA Gun',              origin:'Sweden',      qty:'', status:'Active', range:'12,616 m (13,800 yd / 7.8 mi) eff: 2,000 m (1.1 mi)', weight:'4,680 kg (10,290 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/6/65/40mm-antiaircraftgun-sweden.jpg', notes:'ROF: 80–120 rds/min; Ammo: HE (SD); ၄၀ မမ လေယာဉ်ပစ်အမြောက်' },
    { name:'75/24 Pack Howitzer',        cat:'artillery', type:'75mm Pack Howitzer',          origin:'India',     qty:'', status:'Active', range:'11,100 m (12,043 yd / 6.8 mi)', weight:'880 kg (2,056 lb)',   crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/f/fe/75-24-%E1%80%9F%E1%80%B1%E1%80%AC%E1%80%84%E1%80%BA%E1%80%9D%E1%80%85%E1%80%BA%E1%80%87%E1%80%AC_india.jpg', notes:'ROF: 3 rds/min; Ammo: HE; ၇၅/၂၄ ဟောင်ဝမ်ဇာ (ဝန်တင်) အမြောက်' },
    { name:'76mm Gun M-42',              cat:'artillery', type:'76.2mm Towed Field Gun',       origin:'Yugoslavia', qty:'', status:'Active', range:'13,280 m (14,523 yd / 8.2 mi)', weight:'1,116 kg (2,455 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/a/a2/76-mm-M42-yugoslavia.jpg', notes:'ROF: 15–20 rds/min; Ammo: HE M 70, HEAT BK 354; ၇၆ မမ အမြောက် (M-၄၂)' },
    { name:'76mm Gun M-48',               cat:'artillery', type:'76.2mm Towed Field Gun',       origin:'Yugoslavia', qty:100, status:'Active', range:'8,600 m (9,405 yd / 5.3 mi)', weight:'705 kg (1,554 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/6/6a/76-mm-M48_yugoslavia.jpg', notes:'ROF: 5 rds/min; Ammo: HE M 85/86, HEAT; ၇၆ မမ အမြောက် (M-၄၈)' },
    { name:'25-Pounder Field Gun',       cat:'artillery', type:'87.6mm Towed Field Gun',       origin:'UK',         qty:'150+', status:'Active', range:'12,247 m (13,400 yd / 7.0 mi)', weight:'1,880 kg (4,287 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/3/31/Ordnance_QF_25-pounder_Field_Gun%2C_Saint_John%2C_New_Brunswick.JPG', notes:'ROF: 2–5 rds/min; Ammo: HE, HEAT; ၂၅ ပေါင်ဒ်ဒ အမြောက်' },
    { name:'105mm Howitzer M-56 A1',     cat:'artillery', type:'105mm Pack Howitzer',          origin:'Yugoslavia', qty:'250+', status:'Active', range:'15,100 m std / 18,000 m max (16,440 yd / 9.2 mi — 19,685 yd / 11.2 mi)', weight:'2,200 kg (4,840 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/5/5e/105mm-%E1%80%9F%E1%80%B1%E1%80%AC%E1%80%84%E1%80%BA%E1%80%9D%E1%80%85%E1%80%BA%E1%80%87%E1%80%AC_M56-A1_yugoslavia.jpg', notes:'ROF: 6–7 rds/min; Ammo: HE M 51 A5; ၁၀၅ မမ ဟောင်ဝမ်ဇာ (M-56 A1)' },
    { name:'105mm Howitzer M 2 A1',       cat:'artillery', type:'105mm Towed Howitzer',         origin:'USA',        qty:'100+', status:'Active', range:'11,270 m (12,328 yd / 7 mi)',   weight:'2,264 kg (4,980 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/3/35/105mm-%E1%80%9F%E1%80%B1%E1%80%AC%E1%80%84%E1%80%BA%E1%80%9D%E1%80%85%E1%80%BA%E1%80%87%E1%80%AC_M2A1-US.jpg', notes:'ROF: 2–5 rds/min; Ammo: HE M 51 A5, HE M 564, SMK WP; ၁၀၅ မမ ဟောင်ဝမ်ဇာ (M 2 A1)' },
    { name:'105mm Howitzer M2A1/M2A2',   cat:'artillery', type:'105mm Towed Howitzer',         origin:'Yugoslavia', qty:'', status:'Active', range:'11,270 m std / 18,084 m max (12,328 yd / 7 mi — 19,777 yd / 11.2 mi)', weight:'2,000 kg (4,400 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/e/e9/105mm%E1%80%9F%E1%80%B1%E1%80%AC%E1%80%84%E1%80%BA%E1%80%9D%E1%80%85%E1%80%BA%E1%80%87%E1%80%AC_M2A1M2A2_yugoslavia.jpg', notes:'ROF: 6–7 rds/min; Ammo: HE M 51 A5, HE M 564, SMK WP; ၁၀၅ မမဟောင်ဝမ်ဇာ (M2A1/M2A2)' },

    { name:'107mm MLRS Type-63',           cat:'artillery', type:'107mm MLRS (12-tube, Towed)',     origin:'China',       qty:'', status:'Active', range:'8,500 m (9,295 yd / 5.3 mi)', weight:'613 kg (1,351 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/6/63/H12_Type_63_multiple_rocket_launcher.JPG', notes:'ROF: 12 rds salvo; Ammo: HE, Smoke; ၁၀၇ မမ MLRS Type-63' },
    { name:'120mm Mortar (Yugoslav)',     cat:'artillery', type:'120mm Heavy Mortar',           origin:'Yugoslavia', qty:'', status:'Active', range:'4,760 m shallow / 6,064 m steep / 5,450 m charge-3 (5,205–6,630 yd)', weight:'400 kg (882 lb)',   crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/5/52/120mm-morter_yugoslavia.jpg', notes:'ROF: 4–10 rds/min; Ammo: HE (M-62/M-49), BA-97; ၁၂၀ မမ စိန်ပြောင်း (ယူဂို)' },
    { name:'120mm Mortar (Israeli)',      cat:'artillery', type:'120mm Heavy Mortar',           origin:'Israel',     qty:'100', status:'Active', range:'6,500 m (7,108 yd / 4.0 mi)', weight:'155 kg (345 lb)',   crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/f/f4/120mm-mortar-Israel.jpg', notes:'ROF: 5–10 rds/min; Ammo: HE; ၁၂၀ မမ စိန်ပြောင်း (အစ္စရေး)' },

    { name:'120mm Mortar K-6',            cat:'artillery', type:'120mm Heavy Mortar',            origin:'Israel',     qty:'80', status:'Active', range:'6,290 m / 7,200 m / 5,450 m (3 charges)', weight:'32.5 kg (72 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/160808-F-VH066-018.jpg/1920px-160808-F-VH066-018.jpg', notes:'ROF: 10 rds/min; Ammo: HE (M-48/57), SMK WP; ၁၂၀ မမ စီန်ပြောင်း (K-6)' },
    { name:'120mm Mortar MA-6 MK-I',      cat:'artillery', type:'120.2mm Heavy Mortar',          origin:'Myanmar',    qty:'1,400', status:'Active', range:'~8,400 m', weight:'~172 kg (379 lb)', crew:'', yr:'Late 1980s+', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/e/ee/120mm-MA-6-MK-1-Myanmar.jpg', notes:'ROF: 5–10 rds/min; Ammo: BA-97, MK I ER. Produced by MDPI since the late 1980s. ၁၂၀ မမ စီန်ပြောင်း (MA-6)(MK-I)' },
    { name:'120mm Mortar MA-6 MK-II',     cat:'artillery', type:'120.2mm Heavy Mortar',          origin:'Myanmar',    qty:'1,400', status:'Active', range:'~10,072 m (11,006 yd / 6.9 mi)', weight:'~225 kg (496 lb)', crew:'', yr:'Late 1980s+', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/1/19/120mm-MA-6-MK-2-myanmar%28BA-97%29.jpg', notes:'ROF: 5–10 rds/min; Ammo: MK II ER, BA-97. Produced by MDPI (Myanmar Defence Products Industry) since the late 1980s — up to 50 pieces per year along with ammunition. Widely used in combat operations against insurgents. ၁၂၀ မမ စီန်ပြောင်း (MA-6)(MK-II)' },
    { name:'MA-9 60mm Commando Mortar',   cat:'artillery', type:'60mm Commando Mortar',           origin:'Myanmar',    qty:'~10,000', status:'Active', range:'', weight:'', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/7/78/PatMor60mm_1.JPG', notes:'Infantry fire support weapon. Produced by MDPI — up to 400 pieces per year along with ammunition. Widely used in combat operations against insurgents. MA-9 ၆၀ မမ စစ်ပြန်ပစ်လက်နက်' },
    { name:'MA-7 60mm Extended Range Mortar', cat:'artillery', type:'60mm Extended Range Mortar', origin:'Myanmar',    qty:'~12,000', status:'Active', range:'', weight:'', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/e/ee/5_Podhale_Battalion_-_mortar.JPG', notes:'Infantry fire support weapon. Produced by MDPI — up to 400 pieces per year along with ammunition. Widely used in combat operations against insurgents. MA-7 ၆၀ မမ တိုးချဲ့အကွာပစ်လက်နက်' },
    { name:'122mm Howitzer D 30-2',       cat:'artillery', type:'122mm Towed Howitzer',          origin:'China',      qty:'560+', status:'Active', range:'~22,000 m (24,060 yd / 13.7 mi)', weight:'~3,200 kg (7,050 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/8/81/122-_%D0%BC%D0%BC_%D0%B3%D0%B0%D1%83%D0%B1%D0%B8%D1%86%D0%B0_%D0%94-30_%281%29.jpg', notes:'ROF: 6–8 rds/min; Ammo: HE, ERFB, ERFB-BB; ၁၂၂ မမ ဟောင်ဝမ်ဇာ (D 30-2)' },
    { name:'BM-21 Grad MLRS',         cat:'artillery', type:'122mm Multiple Rocket Sys.',origin:'Russia',         qty:230,  status:'Active',  range:'40 km',     weight:'13.7t', crew:3, yr:'1990s',    price:'~$1.5M/unit', img:'https://upload.wikimedia.org/wikipedia/commons/a/a7/Wyrzutnia_rakietowa_BM-21_Grad_na_podwoziu_Ural-375D.jpg', notes:'40-round area saturation' },
    { name:'122mm MRLS Type-81',          cat:'artillery', type:'122mm MLRS (40-tube, SP)',        origin:'China',       qty:120, status:'Active', range:'20,580 m – 30,000 m', weight:'15,360 kg (33,862 lb)', crew:'6', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/c/cf/122mm-mlrs-type_81-china.jpg?width=320', notes:'ROF: 40 rds / 20 sec; Speed: 70 km/h; ၁၂၂ မမ MRLS TYPE-81' },
    { name:'122mm MRLS (North Korea)',      cat:'artillery', type:'122mm MLRS (40-tube, SP)',        origin:'North Korea', qty:'200+ MAM-01 / 250+ MAM-01A / 150+ MAM-01B', status:'Active', range:'19,300 m (21,107 yd / 12.0 mi)', weight:'2,600 kg launcher (5,730 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/e/e4/122mm-mlrs-n.korea.jpg', notes:'ROF: 40 rds / 20 sec; Ammo: HE 931, Scattering; Rocket: 66–71 kg; ၁၂၂ မမ MRLS (မြောက်ကိုရီးယား)' },
    { name:'M-46 130mm Field Gun',    cat:'artillery', type:'130mm Towed Field Gun',     origin:'Russia',         qty:'~24',  status:'Active',  range:'27,150 m std / 35,000 m BB / 44,000 m RAP', weight:'7,700 kg (17,000 lb)', crew:8, yr:'1990s', price:'~$180K/unit', img:'https://upload.wikimedia.org/wikipedia/commons/b/b0/M-46_Lutsk.jpg', notes:'ROF: 6 rpm normal / 8 rpm burst / 5 rpm sustained; MV: 930 m/s; Caliber: 130mm; Breech: horizontal sliding-wedge; Elevation: −2.5° to 45°; Traverse: 50°; L 11.73m × W 2.45m × H 2.55m; Shell: 130×845mm R; ၁၃၀ မမ M-46 အမြောက်' },
    { name:'155mm Howitzer KH-179',       cat:'artillery', type:'155mm Towed Howitzer',          origin:'South Korea', qty:'100+', status:'Active', range:'~18,100 m std / ~30,000 m RAP', weight:'~6,890 kg (6.89 t)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/b/bc/KH179_155_mm_Towed_howitzer.png', notes:'ROF: 5 rds/min; Ammo: HE M 107; ၁၅၅ မမ ဟောင်ဝမ်ဇာ (KH-179)' },
    { name:'SH1 155mm SP Howitzer',        cat:'artillery', type:'155mm Self-Propelled Wheeled Howitzer', origin:'China',  qty:'150+', status:'Active', range:'~20,000 m std / ~39,000 m ERFB / ~53,000 m ERFB-BB', weight:'22,500 kg (49,603 lb)', crew:'5', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/a/a8/Imagesh1.png', notes:'Armament: 155mm howitzer + 12.7mm MG; FCS: computerised, navigation, C4ISR; Armor: small arms/splinter protection; Road speed: 90 km/h; Op. range: 600 km; L 9.68m × W 2.58m × H 3.50m; Users: Myanmar, Pakistan; SH1 ၁၅၅ မမ တပ်တည်ဟောင်ဝမ်ဇာ' },
    { name:'155mm Howitzer M-845 P',      cat:'artillery', type:'155mm Semi-SP Gun-Howitzer',     origin:'Israel',      qty:72, status:'Active', range:'~39,000 m (42,651 yd / 24.2 mi)', weight:'12,400 kg (12.4 t)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/f/f1/M-71-cannon-deployed.JPG', notes:'ROF: 4 rds/min; Ammo: HE M 107, ERFB, ERFB-BB; Self-propulsion: 17 km/h; ၁၅၅ မမ ဟောင်ဝမ်ဇာ (M-845 P)' },
    { name:'Nora B-52 155mm SP Howitzer', cat:'artillery', type:'155mm/52cal Self-Propelled Gun-Howitzer', origin:'Serbia', qty:'40+', status:'Active', range:'~24,000 m std / ~41,000 m ERFB-BB', weight:'~28,000 kg', crew:'4–5', yr:'', price:'', img:'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhq_boR_gLcwlIhrKZmTzMOUFqQ5iewGSCm34wOh8myF6QZ4_6pfFI2J7qd0B_cHwDhdswz3NLe33miX9zUE1v3BNIkLZaug-CVX9RVgo7Z3jVYAFmglLgJFrQX-Wj9PHRBUC-doG-3cS8E/s1600/20621046_1388727117849921_4949700678971978106_n.jpg', notes:'Mission: counter-battery, AD suppression, C2/logistics neutralization; Ammo: HE ERFB-BB (Zone 10), HE ERFB-BT (Zone 8–10), M107 (Zone 3–8); Optional: laser-guided projectile; Nora B-52 ၁၅၅ မမ တပ်တည်ဟောင်ဝမ်ဇာ' },
    { name:'240mm MRLS (North Korea)',      cat:'artillery', type:'240mm MLRS (12-tube, SP)',        origin:'North Korea', qty:'100+ M-1985/M-1991 / 250+ MAM-02', status:'Active', range:'50,000 m (54,680 yd / 31.1 mi)', weight:'21,300 kg (46,958 lb)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/f/f0/240mm-mlrs-korea.jpg', notes:'ROF: 12 rds / 18–20 sec; Ammo: HE 941; Rocket: 199.2 kg (439 lb); Speed: 70 km/h; ၂၄၀ မမ MRLS (မြောက်ကိုရီးယား)' },
    { name:'SY-300 MLRS',                  cat:'artillery', type:'Long-Range MLRS (SP)',            origin:'China',       qty:'', status:'Active', range:'40,000 m – 130,000 m', weight:'', crew:'', yr:'', price:'', img:'https://tse1.mm.bing.net/th/id/OIP.cBU3LGJDjKFJUMykK-iJgwHaE8?cb=thfvnextfalcon&rs=1&pid=ImgDetMain&o=7&rm=3', notes:'Warheads: anti-personnel, anti-armor, thermobaric/FAE (up to 150 kg); Accuracy: 250 m (INS) / 50 m (INS+GPS); SY-300 ဒုံးပြောင်းစနစ်' },
    { name:'SY-400 MLRS (DF-12A)',         cat:'artillery', type:'Tactical Ballistic Missile System (8-round, SP)', origin:'China', qty:'', status:'Active', range:'~400,000 m (~400 km)', weight:'', crew:'', yr:'', price:'', img:'https://tse3.mm.bing.net/th/id/OIP.CLtf2RauD-G99FIZwwoCFAHaFj?cb=thfvnextfalcon&w=696&h=522&rs=1&pid=ImgDetMain&o=7&rm=3', notes:'Also: DF-12A; 8 canisters, solid-fuel, vertical launch; Guidance: GPS/INS; Warheads: multiple types; Vehicle: Wanshan 8×8, Deutz 517 hp; Road speed: 75 km/h; Op. range: 650 km; SY-400 ဒုံးပြောင်းစနစ်' },
    // AIRCRAFT
    ...
    { name:'Harbin Y-12',             cat:'aircraft',  type:'Light Utility Transport',   origin:'China',          qty:'20',  status:'Active',  price:'', img:['https://cdn.jetphotos.com/full/3/20953_1365555306.jpg','https://i.pinimg.com/736x/7c/67/4d/7c674ddc398b4c2b1f63f73037e30d34.jpg'], speed:'328 km/h', range:'1,340 km', notes:'Y-12 (II) variant. Crew: 2; Capacity: 17 passengers / 1,700 kg payload. Engines: 2× Pratt & Whitney Canada PT6A-27 turboprop, 462 kW (620 hp) each. MTOW: 5,300 kg. Wingspan: 17.235 m; Length: 14.86 m; Height: 5.575 m. Cruise speed: 292 km/h (max) / 250 km/h (econ) at 3,000 m. Service ceiling: 7,000 m. Endurance: 5 hr 12 min. Take-off run: 370 m; Landing run: 340 m.' },
    { name:'FTC-2000G (JL-9 Mountain Eagle)', cat:'aircraft', type:'Light Combat Aircraft / Lead-In Fighter Trainer', origin:'China', qty:'12 delivered / 60 ordered', status:'Active', price:'', speed:'Mach 1.2', range:'', img:['https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgxBL6COXDQ_aAg-RtW1mXQEbSOBimOAE_kkq1V0HaLUA7EFFY8OEdRlIf5-7CxEJAtW5RiQHOzZt-Wfu45UYfn_vJvc8c_MTD7jIxA10s0UwaOe6oBVxcmL_taNM_-lhWhuFfl1048_6afjFL-e_N5b9vtOF5IGVzlJU2VlpT1YXLLPbrZEJCFkJ7dmg/s1428/received_705398784352267.jpeg','https://www.singaporeairshow.com/qql/slot/u145/Content/Newsbyte/SA24%20News/FTC-2000G.JPG','https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/FTC-2000G.jpg/960px-FTC-2000G.jpg'], notes:'Also known as Guizhou JL-9. Dual-seat light combat / lead-in fighter trainer designed to replace legacy J-7/F-7 and MiG-21. 7 hardpoints; max weapons load 3 tonnes. Features diverterless supersonic inlet (DSI). First flight: September 2018. One of the cheapest light fighters on the market. FTC-2000G variant is heavier than trainer FTC-2000 with new wing design for Mach 1.2 capability.' },
    { name:'JF-17 Thunder',           cat:'aircraft',  type:'Single-Engine Lightweight Multirole Fighter', origin:'China/Pakistan', qty:'16', status:'Active', price:'~$25M/unit', speed:'Mach 1.6', range:'3,500 km (ferry)', img:['https://th.bing.com/th/id/R.95d529e79fe0615906771645cd600977?rik=WpWKBgbzMVdPzQ&pid=ImgRaw&r=0','https://i0.wp.com/www.globaldefensecorp.com/wp-content/uploads/2019/12/MAF-JF-17.jpg?resize=678%2C381&ssl=1','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjQRyvZ6kgiT-z-3Qhysu9ozChg7Kd2aIwHHVZh5aU1x3_DLlLkKCZQS9FkFHTnmWN2zGVmIvrUVG8AzJvygWsbUVgSe0cNT6uNdas9uyXNNIRU1p_9Dqfwjz4P539zV2vM/s1600/Myanmar-Air-Force-to-induct-JF-17-fighters-by-end-2017.jpg'], notes:'Jointly developed by Pakistan Aeronautical Complex (PAC) and Chengdu Aircraft Corporation (CAC), China. Supersonic multirole combat aircraft; in service with Myanmar Air Force.' },
    // HELICOPTERS
    ...
    { name:'Mil Mi-17-1V Hip',        cat:'helicopter',type:'Medium Transport Helicopter',origin:'Russia',        qty:'~12', status:'Active',  price:'~$12M/unit', img:['https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgQWlKsX0_P8sWfRnF3lqxqNHyegKUHHb_jRkuH8LZoy8FlitzUO8Wz6AJdgJby3sYKy813QIgBEY8wTl8IP_re3RLi9no7pl9BGzVuo18OxV3b3DhQynZvI51SddDEmcCZF-A1YrafwLw/s1600/mmmilitary.blogspot+%25281%2529.jpg','https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjS16JPf7HfxnD4T2XebvVUAPjE8j63wY13nchfhN-53akvwwyEV63eTP0mU-2rUUcnS6QAx9axyIJ9Uec25hBipOPuDKabQYsRFJIrn8LaWbYakQTmIh5oSJ7qPe0ClqdjMtywSS4bUM4/s1600/mmmilitary.blogspot+%25282%2529.jpg'], speed:'250 km/h', range:'950 km', notes:'Troop lift, resupply, SAR' },
...
const CAPTURED_DATA = [
  ...
  // ── TOWED ARTILLERY ────────────────────────────────────────
  {
    name: '76mm M-48 Mountain Gun',
    type: 'Towed Mountain Howitzer',
    origin: 'Yugoslavia',
    cat: 'artillery',
    total: 13, destroyed: 1, abandoned: 0, captured: 12,
    images: [
      { status: 'destroyed', url: 'https://i.postimg.cc/nrFjxpwQ/2023-12-01-Myanmar-76mm-M-48-Howitzer-Destroyed.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/2Ss164KY/2023-12-01-Myanmar-76mm-M-48-Howitzer-Captured.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/SRgXXMYG/2023-12-19-Myanmar-76mm-M-48-Howitzer-Captured.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/RF5XSM4Y/2024-02-14-Myanmar-76mm-M-48-Howitzer-Captured.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/2jx2YRJH/2024-02-14-Myanmar-76mm-M-48-Howitzer-Captured-02.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/Gt4JzGzd/2024-04-07-Myanmar-76mm-M-48-Howitzer-Captured-01.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/MKjmQ0vY/2024-04-07-Myanmar-76mm-M-48-Howitzer-Captured-02.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/SsvcXj45/2024-04-11-Myanmar-76mm-M-48-Howitzer-Captured-01.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/x8NMLYTd/2024-04-11-Myanmar-76mm-M-48-Howitzer-Captured-02.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/25h9xCyx/2024-04-09-Myanmar-76mm-M-48-Mountain-Gun-Captured-by-Rebel.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/3JBWNvXS/2024-07-30-Myanmar-76mm-M-48-Howitzer-Captured-by-Rebels.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/rpbDc21q/2024-08-01-Myanmar-76mm-M-48-Howitzer-Captured-by-Rebels-01.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/2S0qcZ3b/2024-08-01-Myanmar-76mm-M-48-Howitzer-Captured-by-Rebels-02-02.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/dV20nTbJ/2024-08-26-Myanmar-76mm-M-48-Howitzer-Captured-by-Rebels.jpg' },
    ],
  },
  {
    name: '76mm M1942 ZiS-3',
    type: 'Towed Divisional Gun',
    origin: 'Soviet Union',
    cat: 'artillery',
    total: 4, destroyed: 0, abandoned: 0, captured: 4,
    images: [
      { status: 'captured', url: 'https://i.postimg.cc/prCWGM2V/2023-12-17-Myanmar-2x-122mm-D-30-Howitzer-and-2x-76mm-M1942-Zi-S-3-Captured-02.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/Y92y65yz/2023-12-17-Myanmar-76mm-AT-Gun-M1942-Zi-S-3-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/ZRbRTpYV/2024_06_18_Myanmar_76mm_M1942_ZiS-3_Divisional_Gun_Captured_by_Rebels.jpg' },
    ],
  },
  {
    name: 'Ordnance QF 25-Pounder',
    type: 'Towed Field Gun / Howitzer',
    origin: 'United Kingdom',
    cat: 'artillery',
    total: 2, destroyed: 0, abandoned: 0, captured: 2,
    images: [
      { status: 'captured', url: 'https://i.postimg.cc/bwMHhZTb/2024-05-05-Myanmar-Ordnance-QF-25-Pounder-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/gJdK9bqs/2024-12-26-Myanmar-3-45-in-Ordnance-QF-25-Pounder-Captured-by-Rebel.jpg' },
    ],
  },
  {
    ...
    images: [
      { status: 'captured', url: 'https://i.postimg.cc/bJ7ZZX1B/2024-01-18-Myanmar-105mm-M2-A1-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/2yRb9QQw/2024-01-21-Myanmar-105mm-M2-A1-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/tCmDsfpR/2024-12-26-Myanmar-105mm-M2-A1-Howitzer-Captured-by-Rebel-01.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/13nBwH3G/2024-12-26-Myanmar-105mm-M2-A1-Howitzer-Captured-by-Rebel-02.jpg' },
    ],
  },
  {
    name: '105mm M-56 Howitzer',
    type: 'Towed Pack Howitzer',
    origin: 'Yugoslavia',
    cat: 'artillery',
    total: 29, destroyed: 2, abandoned: 0, captured: 27,
    images: [
      { status: 'destroyed', url: 'https://i.postimg.cc/s2fbCjN8/2024-01-07-Myanmar-105mm-M-56-Howitzer-Destroyed.jpg' },
      { status: 'destroyed', url: 'https://i.postimg.cc/RVqbbnq3/2024-03-14-Myanmar-105mm-M-56-Howitzer-Destroyed.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/CKKwwdF0/2023-11-16-Myanmar-105mm-M-56-Howitzer-Captured.png' },
      { status: 'captured',  url: 'https://i.postimg.cc/nzG87JV2/2023-11-16-Myanmar-105mm-M-56-Howitzer-Captured-02.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/FsmZBPqC/2024-01-08-Myanmar-105mm-M-56-Howitzer-Captured-04-05.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/4Nb84CVT/2024-01-08-Myanmar-105mm-M-56-Howitzer-Captured-03.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/yYzQz6JP/2024-01-08-Myanmar-105mm-M-56-Howitzer-Captured-02.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/Mp9dRy9P/2024-01-08-Myanmar-105mm-M-56-Howitzer-Captured.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/jqnmbkMs/2024-01-07-Myanmar-105mm-M-56-Howitzer-Captured-02.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/DwTt5dd7/2024-01-07-Myanmar-105mm-M-56-Howitzer-Captured.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/9Xv3wjDR/2024-01-06-Myanmar-2x-105mm-M-56-Howitzer-Captured.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/K8vKWvMd/2024-01-07-Myanmar-105mm-M-56-Howitzer-Destroyed.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/9FTNhHtV/2024-01-07-Myanmar-105mm-M-56-Howitzer-Captured-01.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/Qd2P7x8F/2024-01-07-Myanmar-105mm-M-56-Howitzer-Captured-02.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/Y9pdNvJC/2024-03-24-Myanmar-105mm-M-56-Howitzer-Captured-01.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/XvK2yf1P/2024-03-24-Myanmar-105mm-M-56-Howitzer-Captured-02.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/bN3SdsRR/2024-04-01-Myanmar-105mm-M-56-Howitzer-Captured.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/sxxK8tfF/2024-04-01-Myanmar-105mm-M-56-Howitzer-Captured-02.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/V66jLnxn/2024-04-11-Myanmar-105mm-M-56-Howitzer-Captured.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/rFBQbS6B/2024-01-04-Myanmar-105mm-M-56-Howitzer-Captured-by-Rebels.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/CL9WCPJS/2024-05-07-Myanmar-105mm-M-56-Howitzer-Captured-by-Rebels.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/qMM8m68c/2024-05-08-Myanmar-105mm-M-56-Howitzer-Captured-by-Rebel.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/RZJ0WgZm/2024-08-04-Myanmar-105mm-M-56-Howitzer-Captured-by-Rebels-01.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/3JcRrs79/2024-08-04-Myanmar-105mm-M-56-Howitzer-Captured-by-Rebels-02.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/9MFqtmY6/2024-12-10-Myanmar-105mm-M-56-Howitzer-Captured-by-Rebel.jpg' },
      { status: 'captured',  url: 'https://i.postimg.cc/W407f1rt/2024-12-26-Myanmar-2x-105mm-M-56-Howitzer-Captured-by-Rebel.jpg' },
    ],
  },
  {
    name: '155mm Soltam M-845P',
    type: 'Towed Field Howitzer',
    origin: 'Israel',
    cat: 'artillery',
    total: 6, destroyed: 0, abandoned: 0, captured: 6,
    images: [
      { status: 'captured', url: 'https://i.postimg.cc/L83dWPZD/2023-11-25-Myanmar-155mm-Soltam-M-845-P-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/fT1L1Bws/2023-11-25-Myanmar-155mm-Soltam-M-845-P-Howitzer-Captured-02.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/Y0X06YV5/2023-12-26-Myanmar-155mm-Soltam-M-845-P-Howitzer-Captured-02.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/J41dtZR1/2023-12-26-Myanmar-155mm-Soltam-M-845-P-Howitzer-Captured-03.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/s2Fg75Mh/2024-08-05-Myanmar-155mm-Soltam-M-845-P-Howitzer-Captured-by-Rebels.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/Mp6WQyNr/2024-08-05-Myanmar-155mm-Soltam-M-845-P-Howitzer-Captured-by-Rebels-01.jpg' },
    ],
  },

  {
    name: '122mm D-30 Howitzer',
    type: 'Towed Howitzer',
    origin: 'Soviet Union',
    cat: 'artillery',
    total: 41, destroyed: 0, abandoned: 0, captured: 41,
    images: [
      { status: 'captured', url: 'https://i.postimg.cc/pT56PM4k/2023-11-01-Myanmar-122mm-D-30-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/tJMJWP29/2023-11-07-Myanmar-122mm-D-30-M-Howitzer-Captured-02.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/J0DMwF5W/2023-11-07-Myanmar-122mm-D-30-M-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/wj6xMw6D/2023-11-12-Myanmar-122mm-D-30-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/yYn4QsHS/2023-11-21-Myanmar-122mm-D-30-Howitzer-01.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/sXzTCGPf/2023-11-21-Myanmar-122mm-D-30-Howitzer-02.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/7hf7FqRY/2023-11-24-Myanmar-122mm-D-30-Howitzer-Captured-01.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/wMwHnsrn/2023-11-24-Myanmar-122mm-D-30-Howitzer-Captured-02.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/T3zG8xk2/2023-11-24-Myanmar-122mm-D-30-Howitzer-Captured-03.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/GtmnPmpK/2023-12-06-Myanmar-D-30-M-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/pLDFZgK4/2023-12-17-Myanmar-2x-122mm-D-30-Howitzer-and-2x-76mm-M1942-Zi-S-3-Captured-01.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/jdN0SbVD/2023-12-17-Myanmar-122mm-D-30-Howitzer-Captured-02.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/cLMpfBLZ/2023-12-17-Myanmar-122mm-D-30-Howitzer-Captured.png' },
      { status: 'captured', url: 'https://i.postimg.cc/SsJ5jZqf/2024-01-07-Myanmar-2x-122mm-D-30-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/j2fF4LDW/2024-01-07-Myanmar-122mm-D-30-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/mDCYdMSG/2024-01-03-Myanmar-122mm-D-30-Howitzer-Captured-03.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/x8PKQ27x/2024-01-03-Myanmar-122mm-D-30-Howitzer-Captured-02.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/VLDjHzX5/2024-01-03-Myanmar-122mm-D-30-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/wBtcmnyM/2023-12-29-Myanmar-122mm-D-30-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/3x10ncHk/2024-01-14-Myanmar-122mm-D-30-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/htDfz17c/2024-01-18-Myanmar-122mm-D-30-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/qByChFrZ/2024-01-21-Myanmar-122mm-D-30-Destroyed.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/QMvHVQy3/2024-01-25-Myanmar-122mm-D-30-Howitzer-Captured.webp' },
      { status: 'captured', url: 'https://i.postimg.cc/1XrtWL5m/2024-01-25-Myanmar-122mm-D-30-Howitzer-Captured-02.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/pXn6Z175/2024-01-31-Myanmar-2x-122mm-D-30-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/CLLJLrpw/2024-02-11-Myanmar-122mm-D-30-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/tRNgy5f3/2024-01-21-Myanmar-122mm-D-30-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/YCnG73vn/2024-03-05-Myanmar-122mm-D-30-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/tTPYhG2w/2024-03-05-Myanmar-122mm-D-30-Howitzer-Captured-02.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/SNXDGFtC/2024-04-01-Myanmar-122mm-D-30-Howitzer-Captured.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/JzhW39TX/2024-08-04-Myanmar-122mm-D-30-Howitzer-Captured-by-Rebels.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/3xYwZM41/2024-08-07-Myanmar-122mm-D-30-Howitzer-Captured-by-Rebels.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/pVSydvQM/2024-08-28-Myanmar-122mm-D-30-Howitzer-Captured-by-Rebel.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/LX6hJ602/2024-08-29-Myanmar-122mm-D-30-Howitzer-Captured-by-Rebels-01.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/zfkVDR7x/2024-08-29-Myanmar-122mm-D-30-Howitzer-Captured-by-Rebels-02.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/sxgSCJRP/2024_10_01_Myanmar_122mm_D-30_Howitzer_Captured_by_Rebel.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/zD7xrvQg/2024-12-26-Myanmar-122mm-D-30-Howitzer-Captured-by-Rebel.jpg' },
      { status: 'captured', url: 'https://i.postimg.cc/X7vQ73MD/2024-12-26-Myanmar-122mm-D-30-Howitzer-Captured-by-Rebel-02.jpg' },
    ],
  },
...
function toBurmese(n){ return String(n).replace(/[0-9]/g, d => '၀၁၂၃၄၅၆၇၈၉'[d]); }
...
// ═══════════════════════════════════════════════════════════════
// RENDER ARMY — Artillery Commands
// ═══════════════════════════════════════════════════════════════
function renderArtilleryCommands() {
  const grid = $('#artillery-grid');
  if(!grid) return;
  const logo = 'https://upload.wikimedia.org/wikipedia/commons/8/80/Myanmar_Artillery_Corps.svg';
  grid.innerHTML = T.army.artilleryCommands.map((a, i) => {
    const fbId = 'artfb' + i;
    const hasBn = a.battalions && a.battalions.length > 0;
    return `
    <div class="lid-card reveal" onclick="openArtilleryModal(${a.num})" style="cursor:pointer">
      <div class="lid-insignia-wrap">
        <img src="${esc(logo)}" class="lid-insignia-img" alt="Myanmar Artillery Corps" referrerpolicy="no-referrer" onerror="this.style.display='none';document.getElementById('${fbId}').style.display='flex'">
        <div class="lid-insignia-fb" id="${fbId}" style="display:none">
          <span class="lid-fb-num">${a.num}</span>
          <span class="lid-fb-label">မစခ</span>
        </div>
      </div>
      <div class="lid-name" style="font-size:0.78rem">${esc(a.abbr)}</div>
      <div class="lid-location">📍 ${esc(a.hqBurmese)}</div>
      <div class="lid-command">${esc(a.stateBurmese)}</div>
      <div class="lid-info">
        <div class="lid-info-item"><span class="lid-info-label">HQ</span><span class="lid-info-value">${esc(a.hq)}</span></div>
        <div class="lid-info-item"><span class="lid-info-label">တပ်ရင်း</span><span class="lid-info-value">${hasBn ? a.battalions.length : '—'}</span></div>
      </div>
    </div>`;
  }).join('');
}

function openArtilleryModal(num) {
  const a = T.army.artilleryCommands.find(x => x.num === num);
  if(!a) return;
  const bnRows = a.battalions && a.battalions.length
    ? a.battalions.map(b => `
        <tr>
          <td style="white-space:nowrap"><span style="color:var(--gold2);font-size:0.75rem">အမတ(${toBurmese(b.num)})</span></td>
          <td><strong>အမှတ်(${toBurmese(b.num)})အမြောက်တပ်ရင်း</strong></td>
          <td style="color:var(--txt2)">${b.loc ? '📍 ' + esc(b.loc) : ''}</td>
        </tr>`).join('')
    : `<tr><td colspan="3" style="color:var(--txt3);text-align:center;padding:1rem">No battalion data available</td></tr>`;
  showModal(esc(a.abbr), esc(a.burmese), `
    <div class="modal-section">
      <div class="modal-section-title">ဌာနချုပ်အချက်အလက်</div>
      <div class="modal-details">
        <div class="modal-detail"><span class="modal-detail-label">Headquarters</span><span class="modal-detail-value">📍 ${esc(a.hq)} · ${esc(a.hqBurmese)}</span></div>
        <div class="modal-detail"><span class="modal-detail-label">State / Region</span><span class="modal-detail-value">${esc(a.state)} · ${esc(a.stateBurmese)}</span></div>
      </div>
    </div>
    <div class="modal-section">
      <div class="modal-section-title">မှတ်ချက်</div>
      <p style="font-size:0.85rem;color:var(--txt2);line-height:1.7">${esc(a.desc)}</p>
    </div>
    <div class="modal-section">
      <div class="modal-section-title">လက်အောက်ခံ အမြောက်တပ်ရင်းများ ${a.battalions ? `(${a.battalions.length})` : ''}</div>
      <div class="bso-table-wrap" style="margin-top:0.5rem">
        <table class="bso-table">
          <thead><tr><th>အတိုကောက်</th><th>တပ်ရင်း</th><th>အနေအထား</th></tr></thead>
          <tbody>${bnRows}</tbody>
        </table>
      </div>
    </div>`);
...
// ═══════════════════════════════════════════════════════════════
// RENDER ARMY — Armored Operations Commands
// ═══════════════════════════════════════════════════════════════
function renderArmoredCommands() {
  const grid = $('#armored-grid');
  if(!grid) return;
  const logo = 'https://upload.wikimedia.org/wikipedia/commons/7/77/Shoulder_Sleeve_Insignia_of_Myanmar_Armour_Corps.svg';
  const rmcIns = abbr => { const rc = T.army.regionalCommands.find(c => c.abbr === abbr); return rc ? rc.insignia : ''; };
  grid.innerHTML = T.army.armoredCommands.map((a, i) => {
    const fbId = 'armfb' + i;
    const ins = rmcIns(a.cmdAbbr);
    return `
    <div class="lid-card reveal" onclick="openArmoredModal(${a.num})" style="cursor:pointer">
      <div class="lid-insignia-wrap">
        <img src="${esc(logo)}" class="lid-insignia-img" alt="Myanmar Armored Corps" referrerpolicy="no-referrer" onerror="this.style.display='none';document.getElementById('${fbId}').style.display='flex'">
        <div class="lid-insignia-fb" id="${fbId}" style="display:none">
          <span class="lid-fb-num">${toBurmese(a.num)}</span>
          <span class="lid-fb-label">သစခ</span>
        </div>
      </div>
      <div class="lid-name" style="font-size:0.78rem">${esc(a.abbr)}</div>
      <div class="lid-location">📍 ${esc(a.hqBurmese)}</div>
      ...
      <div class="lid-info">
        <div class="lid-info-item"><span class="lid-info-label">HQ</span><span class="lid-info-value">${esc(a.hq)}</span></div>
        <div class="lid-info-item"><span class="lid-info-label">တပ်ရင်း</span><span class="lid-info-value">${a.battalions ? a.battalions.length : '—'}</span></div>
      </div>
    </div>`;
  }).join('');
}

function openArmoredModal(num) {
  const a = T.army.armoredCommands.find(x => x.num === num);
  if(!a) return;
  const rmcIns = abbr => { const rc = T.army.regionalCommands.find(c => c.abbr === abbr); return rc ? rc.insignia : ''; };
  const ins = rmcIns(a.cmdAbbr);
  const bnRows = a.battalions && a.battalions.length
    ? a.battalions.map(b => `
        <tr>
          <td style="white-space:nowrap"><span style="color:var(--gold2);font-size:0.75rem">${esc(b.abbr)}(${toBurmese(b.num)})</span></td>
          <td><strong>အမှတ်(${toBurmese(b.num)})${esc(b.name)}</strong></td>
          <td style="color:var(--txt2)">${b.loc ? '📍 ' + esc(b.loc) : ''}</td>
        </tr>`).join('')
    : `<tr><td colspan="3" style="color:var(--txt3);text-align:center;padding:1rem">No battalion data available</td></tr>`;
  showModal(esc(a.abbr), esc(a.burmese), `
    <div class="modal-section">
      ...
      <div class="modal-details">
        <div class="modal-detail"><span class="modal-detail-label">Headquarters</span><span class="modal-detail-value">📍 ${esc(a.hq)} · ${esc(a.hqBurmese)}</span></div>
        <div class="modal-detail"><span class="modal-detail-label">State / Region</span><span class="modal-detail-value">${esc(a.state)} · ${esc(a.stateBurmese)}</span></div>
        <div class="modal-detail"><span class="modal-detail-label">Parent Command</span><span class="modal-detail-value">${ins ? `<img src="${esc(ins)}" style="width:20px;height:20px;vertical-align:middle;margin-right:0.4rem" referrerpolicy="no-referrer" onerror="this.style.display='none'">` : ''}${esc(a.cmd)} (${esc(a.cmdAbbr)})</span></div>
      </div>
    </div>
    <div class="modal-section">
      <div class="modal-section-title">လက်အောက်ခံတပ်ရင်းများ ${a.battalions ? `(${a.battalions.length})` : ''}</div>
      <div class="bso-table-wrap" style="margin-top:0.5rem">
        <table class="bso-table">
          <thead><tr><th>အတိုကောက်</th><th>တပ်ရင်း</th><th>အနေအထား</th></tr></thead>
          <tbody>${bnRows}</tbody>
...
function initMapFull() {
  const el = $('#myanmar-map-full');
  if(!el) return;
  const mapFull = L.map('myanmar-map-full', { center:[19.5,96.2], zoom:6, zoomControl:true });
  L.tileLayer('https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png', {
    attribution:'© OpenStreetMap contributors © CARTO',
    subdomains:'abcd', maxZoom:18
  }).addTo(mapFull);
  ...
  const iColors = { high:'#e83333', medium:'#f5a623', low:'#f5d623' };
  [
    { name:'Sagaing Region',  coords:[22.2,94.9], r:130000, intensity:'high' },
    { name:'Chin State',      coords:[22.1,93.5], r:80000,  intensity:'high' },
    { name:'Kachin State',    coords:[25.5,97.2], r:100000, intensity:'medium' },
    { name:'N. Shan State',   coords:[23.2,97.8], r:110000, intensity:'high' },
    { name:'Karen/Kayin St.', coords:[18.2,97.2], r:80000,  intensity:'medium' },
    { name:'Rakhine State',   coords:[20.3,93.0], r:120000, intensity:'high' },
  ].forEach(z => {
    L.circle(z.coords, {
      radius:z.r, color:iColors[z.intensity],
      fillColor:iColors[z.intensity], fillOpacity:0.13,
      weight:1.5
    }).bindPopup(`<div style="font-weight:700;color:${iColors[z.intensity]}">${z.name}</div>`)
      .addTo(mapFull);
  });

  // wire the map-ctrl buttons to the full map as well
  $$('.map-ctrl').forEach(btn => {
    btn.addEventListener('click', () => {
      // reflect toggle on full map via re-rendering (simpler: just invalidate size)
...
function openOOCModal(num) {
  ...
  showModal(`OOC-${o.num}`, o.abbr, `
    ...
    <div class="modal-section">
      ...
      <p style="font-size:0.85rem;color:var(--txt2);line-height:1.7">စစ်ဆင်ရေးကွပ်ကဲမှု ဌာနချုပ် (စကခ) ဆိုသည်မှာ တပ်မ အသွင်ပြောင်းယူထားသော တပ်ဖွဲ့ ဖြစ်သည်။ တပ်မများနှင့် စကခများသည် ကက(ကြည်း) - (စစ်ဆင်ရေး)၏ တိုက်ရိုက်ကွပ်ကဲစီမံသော တိုက်ခိုက်ရေးတပ်ဖွဲ့များ ဖြစ်ပြီး စစ်ဆင်ရေးခွင် ပုံသေမရှိဘဲ ရန်သူအင်အားအပေါ် မူတည်ပြီး လိုအပ်သလို စစ်ကစားနိုင်ရန် စီစဉ်ထားခြင်း ဖြစ်သည်။ စကခ-၁၁ မရှိဘဲ စကခ-၂၁ သည် လက်ရှိ တည်ရှိသည့် တပ်ဖွဲ့ ဖြစ်သည်။</p>
    </div>`);
}
...
function openRCHQModal(id) {
  ...
  showModal(r.abbr, r.burmese, `
    ...
    <div class="modal-section">
      ...
      <p style="font-size:0.85rem;color:var(--txt2);line-height:1.7">ဒေသကွပ်ကဲမှုစစ်ဌာနချုပ် (အတိုကောက် ဒကစ) ဆိုသည်မှာ တိုင်းစစ်ဌာနချုပ် တစ်ခု၏ ကွပ်ကဲမှုအောက်တွင်ရှိပြီး ၎င်းတိုင်းစစ်ဌာနချုပ်မှ အလှမ်းဝေးသော ဝေးလံခေါင်ဖျားသည့် နယ်မြေဒေသ၌ တိုင်းစစ်ဌာနချုပ် ကိုယ်စား ၎င်းနယ်မြေဒေသ၏ ကာကွယ်ရေး၊ လုံခြုံရေး နှင့် စစ်ဆင်ရေးကိစ္စရပ်များအား ကွပ်ကဲရန်၊ နယ်မြေအတွင်း၌ရှိသော လက်အောက်ခံ ခြေလျင်/ခြေမြန်တပ်များ နှင့် တွဲဖက်ထားသည့် အကူလက်ရုံး/ ဝန်ထမ်းတပ်များ အားလုံး၏ (စစ်ဦးစီး/ စစ်ရေး/ စစ်ထောက်)ဆိုင်ရာ လုပ်ငန်းများအား စစ်ဆေးခြင်း၊ လမ်းညွှန်ပေးခြင်း နှင့် ဖြေရှင်းဆောင်ရွက်ပေးခြင်းတို့အပြင် တိုင်းစစ်ဌာနချုပ်မှ အမိန့်နှင့် ညွှန်ကြားချက်များအား ထပ်ဆင့်ထုတ်ပြန်ခြင်း စသည့် ကွပ်ကဲမှုပိုင်းဆိုင်ရာ လုပ်ငန်းတာဝန်များအား ထမ်းဆောင်ရသော "တိုင်းစစ်ဌာနချုပ် အလတ်စား" ဖြစ်သည်။</p>
    </div>`);
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  renderOOCs();
  renderRCHQs();
  renderArtilleryCommands();
  renderArmoredCommands();
  renderFleet();
  renderNavyBases();
  renderNavyOverview();
  renderAirForce();
  ...
  if($('#myanmar-map-full')) setTimeout(initMapFull, 150);
