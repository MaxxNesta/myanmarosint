...
const T = {
  ...
  equipment: [
    ...
    { name:'40mm AA Gun',                 cat:'artillery', type:'40mm Towed AA Gun',              origin:'Sweden',      qty:'', status:'Active', range:'12,616 m (13,800 yd / 7.8 mi) eff: 2,000 m (1.1 mi)', weight:'4,680 kg (10,290 lb)', crew:'', yr:'', price:'', img:'', notes:'ROF: 80–120 rds/min; Ammo: HE (SD); ၄၀ မမ လေယာဉ်ပစ်အမြောက်' },
