...
const T = {
  ...
  equipment: [
    ...
    { name:'122mm Howitzer D 30-2',       cat:'artillery', type:'122mm Towed Howitzer',          origin:'China',      qty:'', status:'Active', range:'~22,000 m (24,060 yd / 13.7 mi)', weight:'~3,200 kg (7,050 lb)', crew:'', yr:'', price:'', img:'', notes:'ROF: 6–8 rds/min; Ammo: HE, ERFB, ERFB-BB; ၁၂၂ မမ ဟောင်ဝမ်ဇာ (D 30-2)' },
    { name:'155mm Howitzer KH-179',       cat:'artillery', type:'155mm Towed Howitzer',          origin:'South Korea', qty:'', status:'Active', range:'~18,100 m std / ~30,000 m RAP', weight:'~6,890 kg (6.89 t)', crew:'', yr:'', price:'', img:'https://upload.wikimedia.org/wikipedia/commons/b/bc/KH179_155_mm_Towed_howitzer.png', notes:'ROF: 5 rds/min; Ammo: HE M 107; ၁၅၅ မမ ဟောင်ဝမ်ဇာ (KH-179)' },
    ...
    { name:'155mm Howitzer M-845 P',      cat:'artillery', type:'155mm Semi-SP Gun-Howitzer',     origin:'Israel',      qty:'', status:'Active', range:'~39,000 m (42,651 yd / 24.2 mi)', weight:'12,400 kg (12.4 t)', crew:'', yr:'', price:'', img:'', notes:'ROF: 4 rds/min; Ammo: HE M 107, ERFB, ERFB-BB; Self-propulsion: 17 km/h; ၁၅၅ မမ ဟောင်ဝမ်ဇာ (M-845 P)' },
    ...
    { name:'122mm MRLS (Korea)',           cat:'artillery', type:'122mm MLRS (40-tube, SP)',        origin:'South Korea', qty:'', status:'Active', range:'19,300 m (21,107 yd / 12.0 mi)', weight:'2,600 kg launcher (5,730 lb)', crew:'', yr:'', price:'', img:'', notes:'ROF: 40 rds / 20 sec; Ammo: HE 931, Scattering; Rocket: 66–71 kg; ၁၂၂ မမ MRLS (ကိုရီးယား)' },
    { name:'240mm MRLS (Korea)',           cat:'artillery', type:'240mm MLRS (12-tube, SP)',        origin:'South Korea', qty:'', status:'Active', range:'50,000 m (54,680 yd / 31.1 mi)', weight:'21,300 kg (46,958 lb)', crew:'', yr:'', price:'', img:'', notes:'ROF: 12 rds / 18–20 sec; Ammo: HE 941; Rocket: 199.2 kg (439 lb); Speed: 70 km/h; ၂၄၀ မမ MRLS (ကိုရီးယား)' },
